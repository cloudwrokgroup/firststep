 <!-- ##### SIDEBAR LOGO ##### -->
    ...
    <div class="kt-sideleft">
      ...
      <ul class="nav kt-sideleft-menu">
        <li class="nav-item">
          <a href="<?php echo portal_url()?>" class="nav-link active">
      ...
      <div class="kt-headpanel-right">
            ...
            <div class="media-list">
              ...
              <a href="" class="media-list-link read">
                <div class="media pd-x-20 pd-y-15">
                  <img src="<?php echo asset_url()?>img/img8.jpg" class="wd-40 rounded-circle" alt="">
              ...
              <a href="" class="media-list-link read">
                <div class="media pd-x-20 pd-y-15">
                  <img src="<?php echo asset_url()?>img/img9.jpg" class="wd-40 rounded-circle" alt="">
                  <div class="media-body">
              ...
              <a href="" class="media-list-link read">
                <div class="media pd-x-20 pd-y-15">
                  <img src="<?php echo asset_url()?>img/img10.jpg" class="wd-40 rounded-circle" alt="">
                  <div class="media-body">
              ...
              <a href="" class="media-list-link read">
                <div class="media pd-x-20 pd-y-15">
                  <img src="<?php echo asset_url()?>img/img5.jpg" class="wd-40 rounded-circle" alt="">
                  <div class="media-body">
        ...
        <div class="dropdown dropdown-profile">
          <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
            <img src="<?php echo asset_url()?>img/img3.jpg" class="wd-32 rounded-circle" alt="">
            <span class="logged-name"><span class="hidden-xs-down"><?php echo $this->session->userdata['logged_in']['username']?></span> <i class="fa fa-angle-down mg-l-3"></i></span>
          </a>
          <div class="dropdown-menu wd-200">
            <ul class="list-unstyled user-profile-nav">
              ...
              <li><a href="<?php echo portal_url()?>logout"><i class="icon ion-power"></i> Sign Out</a></li>
            </ul>
          </div><!-- dropdown-menu -->
        </div><!-- dropdown -->
    ...
    <div class="kt-breadcrumb">
      <nav class="breadcrumb">
        <a class="breadcrumb-item" href="index.html">First Step</a>
